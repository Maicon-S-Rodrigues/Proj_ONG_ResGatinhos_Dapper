...
namespace Proj_ONG_ResGatinhos_Dapper.Model
{
    public class Animal
    {
        ...
        public readonly static string ExistsDisponivel = "SELECT Situacao FROM Animal WHERE CHIP = @Chip AND Situacao = 'DISPONIVEL'";
        ...
        {
            return " | CHIP: " + this.Chip + " | Família: " + this.Familia + " | Raça: " + this.Raca + " |" +
